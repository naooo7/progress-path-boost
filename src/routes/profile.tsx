...
function ProfilePage() {
  ...
  return <Page narrow>
    ...
    <div className="mb-5 flex items-center gap-4"><div className="flex h-16 w-16 items-center justify-center rounded-full bg-foreground font-display text-xl font-bold text-primary-foreground">N</div><div><h2 className="font-display text-2xl font-bold">Nao</h2><p className="text-muted-foreground">Studying with focus</p></div><div className="ml-auto hidden items-center gap-2 rounded-full bg-secondary px-3 py-2 text-sm font-semibold sm:flex"><Flame className="h-4 w-4 text-primary" />{streak.current} day streak</div></div>
